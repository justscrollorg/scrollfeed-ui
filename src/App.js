...
function App() {
  ...
  const fetchTopVideos = () => {
    fetch(`${API_BASE}/videos?region=${selectedRegion}&category=${selectedCategory}&maxResults=${maxResults}`)
      .then(res => res.json())
      .then(setVideos)
  ...
  return (
    <div className="app-container">
      ...
      <div className="search-section">
        <input type="text" placeholder="Search for videos..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} />
